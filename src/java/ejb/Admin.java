...
//    @Override
//    public void serviceDetail(Integer ServiceOrderId, Integer ServiceId, String cratedAt, String updatedAt) {
//        TblServiceorder so = em.find(TblServiceorder.class, ServiceOrderId);
//        TblServices ts = em.find(TblServices.class, ServiceId);
//        TblServicelist sl = new TblServicelist();
//        TblServicelistPK tk = new TblServicelistPK();
//        tk.setUserVehicleId(so.getServiceorderId());
//        tk.setServiceId(ts.getServiceId());
//        sl.setTblServicelistPK(tk);
//        sl.setCreatedAt(cratedAt);
//        sl.setUpdatedAt(updatedAt);
//        em.persist(sl);
//    }
//
//    @Override
//    public void orderDetail(Integer orderId, Integer PartId, String createdAt, String updatedAt) {
//        TblOrder to = em.find(TblOrder.class, orderId);
//        TblParts tp = em.find(TblParts.class, PartId);
//        TblOrderdetail td = new TblOrderdetail();
//        TblOrderdetailPK tk = new TblOrderdetailPK();
//        tk.setOrderId(to.getOrderId());
//        tk.setPartId(tp.getPartId());
